...
export default function DeleteBrandButton({ brandId, brandName, productCount }: Props) {
  ...
  return (
    <button
      onClick={() => {
        if (productCount > 0) {
          alert(`Cannot delete "${brandName}" — it has ${productCount} product(s). Delete or reassign those products first.`)
          return
        }
        setConfirming(true)
      }}
