  ...
  return (
    <section className="py-14 sm:py-20 lg:py-24 px-4 sm:px-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 sm:mb-14 gap-4">
        ...
        <Link href="/products" className="text-xs tracking-widests uppercase text-bark-600 hover:text-bark-900 transition-colors font-sans border-b border-bark-300 hover:border-bark-600 pb-0.5 self-start sm:self-auto min-h-0">
          View All →
        </Link>
      </div>
